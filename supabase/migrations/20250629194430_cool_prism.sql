/*
  ...
  1. New Tables
    - `program_details`
      ...
      - `features` (text array, default empty)
      - `curriculum` (text array, default empty)
      - `facilities` (text array, default empty)
      - `schedule` (text)
      - `age_range` (text)
      - `class_size` (text)
  ...
  3. Initial Data
    - Insert default program details for PAUD, TKA/TPA, and Diniyah programs
*/
