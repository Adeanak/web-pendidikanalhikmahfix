/*
  # Create PPDB Tables and Configuration

  1. New Tables
    - `ppdb_form_config` - Stores form field configuration
    - `ppdb_test_schedules` - Manages test schedules for different programs
    - `ppdb_settings` - Controls registration periods and settings

  2. Security
    - Enable RLS on all tables
    - Add policies for public read access and admin management
    - Add policies for authorized users with PPDB permissions
