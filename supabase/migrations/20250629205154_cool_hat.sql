/*
  ...
  1. New Tables
    - `program_details` - Stores detailed information about educational programs
      ...
      - Facilities and schedule information
      - Pricing details (fees)
      - Image gallery

  2. Security
    - Enable RLS on program_details table
    - Add policies for public and authenticated access
    - Add management policies for admins and authorized users
*/
...
-- Insert TKA/TPA program details
INSERT INTO program_details (
  program_id, title, subtitle, description, features, curriculum, facilities,
  schedule, age_range, class_size, monthly_fee, registration_fee, uniform_fee, book_fee, images
) VALUES (
...
-- Insert Diniyah program details
INSERT INTO program_details (
  program_id, title, subtitle, description, features, curriculum, facilities,
  schedule, age_range, class_size, monthly_fee, registration_fee, uniform_fee, book_fee, images
) VALUES (
