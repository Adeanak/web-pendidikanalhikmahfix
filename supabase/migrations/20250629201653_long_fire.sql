/*
  ...
  1. New Tables
    - `program_details` - Stores detailed information about educational programs
      ...
      - `program_id` (text, unique) - Identifier for the program
      - `title` (text) - Program title
      - `subtitle` (text) - Program subtitle
      - `description` (text) - Program description
      - Various arrays for features, curriculum, facilities
      - Schedule, age range, class size information
      - Fee information (monthly, registration, uniform, books)
      - `images` (text array) - Program images
      - Timestamps for created_at and updated_at
  
  2. Security
    - Enable RLS on program_details table
    - Add policies for public and authenticated users to read
