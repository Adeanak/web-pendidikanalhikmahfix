/*
  ...
  1. Changes
     - Creates website_settings table if it doesn't exist
     - Adds unique constraint to ensure only one settings row
     - Enables Row Level Security
     - Adds policies for public read access and admin management
